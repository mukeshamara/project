...
public class BooksDAO {
   ...
   // private static DataSource dataSource;
	public static List<Integer> findbooks(String from) throws ClassNotFoundException, SQLException
	...
	public static String search(int bookid) throws SQLException, ClassNotFoundException
