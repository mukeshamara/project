...
<sql:setDataSource driver="com.mysql.jdbc.Driver"
    ...
    <sql:query var="stmt" dataSource="${mysrc}">
        ...
        select p.book_id,p.book_name,p.Language,p.Delivery_Time,p.Author_Name,p.price,a.quantity_needed from product p join add_to_cart a on(a.book_id=p.book_id) where a.price_per_book>0 and order_id='${sessionScope.y1}';
